...
const planFeatures: Record<PlanId, string[]> = {
  starter: [
    ...
    "~150 content pieces/mo (30 premium Opus + FAQ & schema)",
    "Basic SERP tracking",
  ],
  professional: [
    ...
    "~1,500 content pieces/mo (5 sites · 300 premium Opus)",
  ...
  enterprise: [
    ...
    "Scales with sites (~300/mo per site · 60 premium Opus)",
    "All features",
...
const planFeaturesJa: Record<PlanId, string[]> = {
  starter: [
    ...
    "5キーワード",
    "3チャネル配信",
    "月約150点（プレミアムOpus 30本＋FAQ・構造化データ）",
    "基本SERP追跡",
  ],
  professional: [
    "AIサイクル: 1時間ごと（1日24回）",
    ...
    "50キーワード",
    "10チャネル配信",
    "月約1,500点（5サイト・うちプレミアムOpus 300本）",
    "SERP + LLM引用追跡",
    "競合分析",
    "CMS自動投稿",
    "優先サポート",
