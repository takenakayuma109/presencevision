...
export const techTerms: Record<string, { ja: string; en: string }> = {
  ...
  "SERP": { ja: "Search Engine Results Page（検索結果ページ）— Googleで検索したときに出る結果一覧。その中で自社ページが何番目に出るかを追跡します。", en: "Search Engine Results Page — the list of results shown when you search on Google." },
  "LLM": { ja: "Large Language Model（大規模言語モデル）— ChatGPTやGeminiなど、文章で答えるAIのこと。", en: "Large Language Model — AI like ChatGPT or Gemini that answers in natural language." },
  "GBP": { ja: "Google Business Profile（Googleビジネスプロフィール）— Google検索やマップに表示される、店舗・会社の無料情報枠。", en: "Google Business Profile — the free business listing shown on Google Search and Maps." },
  "CMS": { ja: "Content Management System（コンテンツ管理システム）— WordPress等、サイトの記事を管理・公開する仕組み。", en: "Content Management System — software like WordPress for managing and publishing site content." },
  "AI引用率": { ja: "ChatGPT等のAIが回答の中で自社を引用・言及した割合。高いほどAIに信頼されている証拠です。", en: "The share of AI answers that cite or mention your brand." },
