...
import { BrandConfig } from "@/components/settings/brand-config";
import { ChannelConnect } from "@/components/settings/channel-connect";

type EngineConnectionStatus = "idle" | "testing" | "connected" | "error";

type SettingsTab = "general" | "brand" | "channels";

const TABS: { value: SettingsTab; label: string }[] = [
  { value: "general", label: "一般設定" },
  { value: "brand", label: "ブランド設定" },
  { value: "channels", label: "チャネル接続" },
];
